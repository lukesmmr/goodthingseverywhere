...
<div class="post-meta">
	<time class="published journal-date" datetime="<?php echo get_the_time('c'); ?>">
		<?php echo get_the_date('j. M y'); ?>, <a target="_blank" href="http://maps.google.com/?q=<?php echo $post_loc_lat; ?>,<?php echo $post_loc_lng; ?>&z=12" class="maps-link"><?php echo $post_loc; ?></a>
	</time>
